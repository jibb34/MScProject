...
slope and moving average deviation metrics, then cross-validated our “expected” algorithmic labels against “observed” rider feedback on a set of
test routes. Discrepancies such as segments tagged as \emph{flat} that riders described as \emph{challenging}—fed back into an iterative
calibration loop, ensuring our computational definitions stay grounded in real-world cycling experience rather than abstract mathematical
constructs.
%────────────────────────────────────────────────────────────────────────────────
